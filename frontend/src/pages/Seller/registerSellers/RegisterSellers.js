...
import emptyCart from "../../../assets/images/emptyCart.png"; // Define the emptyCart image (adjust the path as necessary) assets/images/emptyCart.png
import { useSelector } from "react-redux"; //useSelector
// import Cover from "./Cover"; // เปลี่ยนเส้นทางให้ตรงกับโครงสร้างโปรเจกต์ของคุณ
...
const SellerRegister = () => {
  ...
  // localStorage.setItem('status_seller', isSeller); // || 'false'
    ...
    if (userId) { // && !isSeller
      axios.get(`${BASE_URL}/api/check-status-user_seller/${userId}`,{
        ...
        .then(response => {
          ...
          //   setIsSeller(false); // ถ้า user เป็น seller แล้ว
          // }
          // localStorage.setItem('status_seller', isSeller); // || 'false'
  ...
  return (
    <div>
        {isLoggedIn ? (
          // <div className="">
          // <div className="flex flex-col px-4 py-4 h-[80vh] justify-self-center w-screen items-center xs:w-[150vh] xs:mr-[20%] xs:ml-[20%] xs:pt-[90%] xs:pb-[90%] sm:w-[150vh] sm:pt-[90%] sm:pb-[90%] smls:w-[170vh] smls:pt-[75%] smls:pb-[75%] md:w-[170vh] md:pt-[45%] md:pb-[45%] mdl:w-[170vh] mdl:pt-[45%] mdl:pb-[45%] lg:w-[200vh] lg:pb-[35%] lg:pt-[35%]  lgl:w-[150vh] xl:w-[200vh] lgl:pb-[20%] lgl:pt-[20%] xl:pt-[25%] xl:pb-[25%] justify-center bg-gradient-to-b  "> {/*lg:w-[115vh] min-h-screen from-blue-800 to-pink-500 */}
          ...
          >
            ...
            <div className="max-w-[500px] p-4 py-8 bg-white flex gap-4 flex-col items-center rounded-md shadow-lg">
              <h1 className="font-titleFont text-xl font-bold uppercase">
                You need to log in to access your RegisterSeller.
              </h1>
              <Link to="/signin">

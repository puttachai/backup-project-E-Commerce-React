...
const SellerCentreDashboard = () => {
  ...
  return (
    <>
      ...
      {isLoggedIn ? (
        <div className="test">
          <h1 className="mx-4 mt-4 pb-0 ml-[35px] font-bold  text-3xl text-sky-300 text-2xl bg-gradient-to-r from-[#092fc4] via-[#216ad9] to-[#38a4ee] text-transparent bg-clip-text">
            Seller Centre
          </h1>

          <div className="flex h-full px-4 py-4 pr-12 mb-4">
            {" "}
            {/* px-4 py-4 */}
            {/* Sidebar Menu */}
            <aside className="w-96 pt-4 bg-white-100 border-r h-full">
              <nav className="p-4 space-y-2">
                <h2 className="font-bold text-lg">คำสั่งซื้อ</h2>
                <ul className="space-y-1">
                  <Link to="/seller/mdc">
                    <li className="hover:text-blue-500 pl-4">
                      คำสั่งซื้อของฉัน
                    </li>
                  </Link>
                  {/* <li>
                    <a href="#" className="hover:text-blue-500 pl-4">
                      จัดส่งแบบชุด
                    </a>
                  </li> */}
                  <li>
                ...
                <ul className="space-y-1">
                  <Link to="/seller/pmg">
                    <li className="hover:text-blue-500 pl-4">สินค้าของฉัน</li>
                  </Link>
